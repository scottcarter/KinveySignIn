...
- (void) showModally
{
    dispatch_async(dispatch_get_main_queue(), ^{
        ...
        nav.modalTransitionStyle = self.modalTransitionStyle;
...
- (void) layoutLandscape
{
    ...
    signInFrame.size.width -= kLandscapeLoginInterspacing * 3. + _socialLogins.count * signInFrame.size.height + ((NSInteger)_socialLogins.count - 1) * kLandscapeLoginSocialInterspacing;
