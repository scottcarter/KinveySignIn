...
- (void)setup
{
    ...
    _instructionLabel.text = NSLocalizedString(@"Before you can sign in, please check your email to activate your user account. If you don't receive an email in a few seconds, please check your spam filters.", @"Email not verified message.");
...
- (void) viewWillLayoutSubviews
{
    ...
    CGRect buttonFrame = CGRectMake(tenP, CGRectGetMaxY(labelFrame) + buttonMargin, eightyP, 30.);
